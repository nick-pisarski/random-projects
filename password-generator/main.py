...
import logging
from os import path
from lib.generators import NameGenerator, NumberStringGenerator, SpecialCharGenerator
...
def main():
    ...
    try:
        ...
        while get_new_password == 'Y':
            ...
            get_new_password = str(input('Generate another password (Y/N): ')).capitalize()
